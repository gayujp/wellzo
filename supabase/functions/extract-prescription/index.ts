...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Processing prescription image with AI vision');
        ...
        messages: [
          {
            ...
            content: [
              {
                type: 'text',
                text: `Please extract and format all text from this medical prescription image. 
Include:
...
Format it clearly and professionally.`
    ...
    console.log('Prescription extracted successfully');
